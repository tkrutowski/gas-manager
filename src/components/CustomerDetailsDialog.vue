        ...
        <div class="space-y-4">
            ...
            <div
                ...
                <div class="flex-1">
                    ...
                    <p v-if="props.customer.customerType === 'company' && props.customer.nip"
                ...
                <div :class="[
                    ...
                    <span :class="[
                        ...
                        props.customer.status ? 'bg-green-500' : 'bg-gray-500'
                    ]"></span>
                    <span :class="[
                        'text-sm font-medium',
                        props.customer.status
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <h3 class="text-xs font-medium text-surface-600 dark:text-surface-400 uppercase">Dane kontaktowe
                        </h3>
                    </div>
                    <div class="space-y-3">
                        <div>
                ...
                <div class="bg-surface-50 dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg p-4"
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <h3 class="text-xs font-medium text-surface-600 dark:text-surface-400 uppercase">Adres
                            instalacji</h3>
                    </div>
                    <div class="space-y-3">
                        <div>
                            <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1">Ulica i
                                numer</label>
                            <p class="text-sm font-semibold text-surface-900 dark:text-surface-300">
                        ...
                        <div class="flex items-start justify-between gap-4">
                            <div class="flex-1">
                                <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1">Miasto /
                                    Dzielnica</label>
                                <p class="text-sm font-semibold text-surface-900 dark:text-surface-300">
                                    {{ props.customer.address.city }}{{ props.customer.address.commune ? `,
                                    ${props.customer.address.commune}` : '' }}
                                </p>
                            </div>
                            <div>
                                <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1">Kod
                                    pocztowy</label>
                                <p class="text-sm font-semibold text-surface-900 dark:text-surface-300">
