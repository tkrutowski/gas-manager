...
<template>
  <div class="min-h-screen bg-[#2d3a2d] flex items-center justify-center p-4">
    <div class="w-full max-w-6xl bg-dark-bg rounded-2xl overflow-hidden shadow-2xl">
      <div class="flex flex-col lg:flex-row min-h-[600px]">
        ...
        <div class="lg:w-1/2 bg-dark-bg-hover p-8 lg:p-12 flex flex-col justify-center">
          <div class="max-w-md mx-auto w-full">
            ...
            <form @submit.prevent="handleLogin" class="space-y-6">
              ...
              <div>
                ...
                <input id="email" v-model="email" type="email" placeholder="wpisz.email@firma.pl"
                  class="w-full px-4 py-3 bg-dark-bg border border-dark-border-input rounded-lg text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent transition-all" />
              </div>
              ...
              <div>
                ...
                <div class="relative">
                  <input id="password" v-model="password" :type="showPassword ? 'text' : 'password'"
                    placeholder="••••••••"
                    class="w-full px-4 py-3 bg-dark-bg border border-dark-border-input rounded-lg text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent transition-all pr-12" />
              ...
              <div class="flex items-center justify-between">
                <label class="flex items-center gap-2 cursor-pointer">
                  <input v-model="rememberMe" type="checkbox"
                    class="w-4 h-4 rounded border-dark-border-input bg-dark-bg text-primary-400 focus:ring-primary-400 focus:ring-2" />
