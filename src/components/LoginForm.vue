      ...
      <div class="flex flex-col lg:flex-row min-h-[600px]">
        ...
        <div
          ...
          <div class="relative z-10 mt-auto">
            ...
            <h2 class="text-3xl font-bold text-surface-700 dark:text-surface-300 mb-4">Zarządzaj infrastrukturą
              bezpiecznie.</h2>
            <p class="text-surface-600 dark:text-surface-400 text-lg">System dla profesjonalistów i projektantów
              instalacji gazowych.</p>
          </div>
        </div>
        ...
        <div class="lg:w-1/2 bg-surface-50 dark:bg-surface-900 p-8 lg:p-12 flex flex-col justify-center">
          <div class="max-w-md mx-auto w-full">
            ...
            <form @submit.prevent="handleLogin" class="space-y-6">
              <!-- Pole email -->
              <div>
                <label for="email" class="block text-surface-700 dark:text-surface-300 text-sm font-medium mb-2"> Adres
                  e-mail </label>
