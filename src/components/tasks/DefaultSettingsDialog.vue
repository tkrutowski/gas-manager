...
<template>
    <Dialog :visible="true" :modal="true" :closable="true" :draggable="false"
        :style="{ width: sectionName === 'team' ? '600px' : '500px' }" @update:visible="handleClose"
        ...
        <div class="space-y-4">
            ...
            <div v-if="sectionName === 'customer' || sectionName === 'endCustomer'">
                ...
                <div class="relative">
                    ...
                    <button v-if="selectedCustomer" type="button"
                        @click="selectedCustomer = null; customerSearchQuery = ''"
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                    Ta wartość będzie automatycznie ustawiana przy tworzeniu nowego zadania. Możesz ją usunąć klikając
                    ikonę X.
                </p>
            </div>
            ...
            <div v-if="sectionName === 'finance'">
                ...
                <Select v-model="selectedGasDistribution" :options="gasDistributionsStore.activeGasDistributions"
                    placeholder="Wybierz jednostkę..." class="w-full" optionLabel="name" :filter="true"
            ...
            <div v-if="sectionName === 'team'" class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button v-if="selectedDesigner" type="button"
                            @click="selectedDesigner = null; designerSearchQuery = ''"
                            class="absolute right-12 top-1/2 -translate-y-1/2 text-surface-500 dark:text-surface-400 hover:text-surface-700 dark:hover:text-surface-200 transition-colors z-10"
                            title="Usuń wybraną wartość">
                            <i class="pi pi-times text-sm"></i>
                        </button>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button v-if="selectedCoordinator" type="button"
                            @click="selectedCoordinator = null; coordinatorSearchQuery = ''"
                            class="absolute right-12 top-1/2 -translate-y-1/2 text-surface-500 dark:text-surface-400 hover:text-surface-700 dark:hover:text-surface-200 transition-colors z-10"
                            title="Usuń wybraną wartość">
                            <i class="pi pi-times text-sm"></i>
                        </button>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button v-if="selectedCoordinatorProject" type="button"
                            @click="selectedCoordinatorProject = null; coordinatorProjectSearchQuery = ''"
                            class="absolute right-12 top-1/2 -translate-y-1/2 text-surface-500 dark:text-surface-400 hover:text-surface-700 dark:hover:text-surface-200 transition-colors z-10"
                            title="Usuń wybraną wartość">
                            <i class="pi pi-times text-sm"></i>
                        </button>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Te wartości będą automatycznie ustawiane przy tworzeniu nowego zadania. Możesz je usunąć klikając
                    ikonę X
                    przy każdym polu.
                </p>
            </div>
            ...
            <div v-if="(sectionName === 'customer' || sectionName === 'endCustomer' || sectionName === 'finance') && currentDefault"
