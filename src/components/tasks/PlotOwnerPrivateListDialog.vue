...
<template>
  <Dialog
    ...
    header="Właściciele prywatni - Lista"
    class="p-fluid"
  >
    <Card class="border border-surface-200 dark:border-surface-700 overflow-hidden">
      ...
      <template #content>
        <div class="space-y-4">
          <!-- Lista właścicieli prywatnych -->
          <div
            v-for="owner in plotOwnerPrivateList"
            :key="owner.id"
          ...
          >
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-6 gap-3">
                <!-- IMIĘ -->
                <div class="mt-3">
                  <label class="block text-xs uppercase text-surface-600 dark:text-surface-400 mb-1"> IMIĘ </label>
                ...
                <!-- NAZWISKO -->
                <div class="mt-3">
                  <label class="block text-xs uppercase text-surface-600 dark:text-surface-400 mb-1"> NAZWISKO </label>
                  <p class="text-sm text-surface-700 dark:text-surface-300 m-0">
                ...
                <div class="mt-3">
                  ...
                  <p class="text-sm text-surface-700 dark:text-surface-300 m-0">{{ owner.share || 0 }}%</p>
                </div>
              ...
              <!-- Termin dodatkowy I -->
              <div
                v-if="owner.submissionDate1 || owner.receiptDate1 || owner.info1"
                class="mt-4 pt-4 border-t border-surface-200 dark:border-surface-700"
              >
                <label class="block text-xs uppercase text-surface-600 dark:text-surface-400 mb-2 font-bold">
                  TERMIN DODATKOWY I
                </label>
              ...
              <!-- Termin dodatkowy II -->
              <div
                v-if="owner.submissionDate2 || owner.receiptDate2 || owner.info2"
                class="mt-4 pt-4 border-t border-surface-200 dark:border-surface-700"
              >
                <label class="block text-xs uppercase text-surface-600 dark:text-surface-400 mb-2 font-bold">
                  TERMIN DODATKOWY II
