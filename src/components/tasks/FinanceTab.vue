...
const handleSaveCost = () => {
    ...
    if (editingCostId.value !== null) {
        ...
        const index = costList.findIndex(
            c => c.id === editingCostId.value
        );
        if (index !== -1) {
            costList[index] = {
                ...costList[index],
...
<template>
    <div class="space-y-6">
                            ...
                            <div class="space-y-4 p-4">
                                <div>
                                    ...
                                    <InputNumber
                                        ...
                                        }" :disabled="isReadonly" :min="0" :maxFractionDigits="2" :useGrouping="false"
                                        mode="decimal" class="w-full" suffix=" zł." />
                                </div>
                                <div>
                                    <label
                                        class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">
                        ...
                        <template #content>
                            <div class="space-y-4 p-4">
                                <div>
                                    ...
                                    <InputNumber :modelValue="gasConnection?.gasConnectionFinance?.financeProjectAmount"
                                        @update:modelValue="(val) => {
                                            if (gasConnection?.gasConnectionFinance) {
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        <Select v-model="costFormData.costType" :options="costTypeOptions"
                                            optionLabel="label" optionValue="value" placeholder="wybierz" class="flex-1"
                                            :disabled="isReadonly" />
                                        <Button label="Nowy" severity="secondary" size="small" :disabled="isReadonly"
                                ...
                                <div>
                                    ...
                                    <DatePicker v-model="costFormData.paymentDate" :disabled="isReadonly"
                                ...
                                <div>
                                    ...
                                    <InputNumber v-model="costFormData.amount" :disabled="isReadonly" :min="0"
                                        :maxFractionDigits="2" :useGrouping="false" mode="decimal" class="w-full" />
                                </div>
                            ...
                            <div>
                                ...
                                <Textarea v-model="costFormData.description" :disabled="isReadonly" :rows="10"
                                    class="w-full" />
                            </div>
                        </div>
                    </template>
                                ...
                                <template #body="{ data }">
                                    <div class="flex items-center gap-2">
                                        <Button icon="pi pi-pencil" text severity="secondary" rounded
                                            :disabled="isReadonly" @click="handleEditCost(data)" />
                                        <Button icon="pi pi-trash" text severity="danger" rounded :disabled="isReadonly"
        ...
        <Dialog v-model:visible="newCostTypeDialogVisible" modal header="Dodaj nowy typ kosztu"
            :style="{ width: '500px' }">
            <div class="space-y-4 p-4">
                <div>
                    <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">
                    ...
                    <InputText v-model="newCostTypeName" placeholder="wprowadź nazwę" class="w-full"
