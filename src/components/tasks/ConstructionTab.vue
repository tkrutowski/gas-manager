                ...
                <template #content>
                    <div class="space-y-4">
                        <div>
                            ...
                            <DatePicker :modelValue="gasConnection?.gasConnectionBuild?.surveyingSketchesDate"
                                @update:modelValue="(val) => {
                                    if (gasConnection?.gasConnectionBuild) {
                        ...
                        <div>
                            ...
                            <DatePicker :modelValue="gasConnection?.gasConnectionBuild?.surveyingInventoryDate"
                                @update:modelValue="(val) => {
                                    if (gasConnection?.gasConnectionBuild) {
                ...
                <template #content>
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <DatePicker :modelValue="gasConnection?.gasConnectionBuild?.realizationStartDate"
                                    @update:modelValue="(val) => {
                                        if (gasConnection?.gasConnectionBuild) {
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <DatePicker :modelValue="gasConnection?.gasConnectionBuild?.realizationEndDate"
                                    @update:modelValue="(val) => {
                                        if (gasConnection?.gasConnectionBuild) {
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <DatePicker :modelValue="gasConnection?.gasConnectionBuild?.wsgTechnicalAcceptanceDate"
                                    @update:modelValue="(val) => {
                                        if (gasConnection?.gasConnectionBuild) {
                        ...
                        <div>
                            ...
                            <InputText :modelValue="gasConnection?.gasConnectionBuild?.technicalAcceptanceProtocolNo"
                                @update:modelValue="(val) => {
                                    if (gasConnection?.gasConnectionBuild) {
                                        gasConnection.gasConnectionBuild.technicalAcceptanceProtocolNo = val as string;
                                    }
                                }" :disabled="isReadonly" placeholder="" class="w-full" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">
                                Nr inw. gazociągu
                            </label>
                            <InputText :modelValue="gasConnection?.gasConnectionBuild?.gasPipelineInventoryNumber"
                                @update:modelValue="(val) => {
                                    if (gasConnection?.gasConnectionBuild) {
                        ...
                        <div>
                            ...
                            <InputNumber :modelValue="gasConnection?.gasConnectionBuild?.gasConnectionRealLength"
                                @update:modelValue="(val) => {
                                    if (gasConnection?.gasConnectionBuild) {
                                        gasConnection.gasConnectionBuild.gasConnectionRealLength = val as number || 0;
                                    }
                                }" :disabled="isReadonly" :min="0" :maxFractionDigits="4" :useGrouping="false"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <DatePicker :modelValue="gasConnection?.gasConnectionBuild?.wsgFinalAcceptanceDate"
                                @update:modelValue="(val) => {
                                    if (gasConnection?.gasConnectionBuild) {
                        ...
                        <div>
                            ...
                            <Textarea :modelValue="gasConnection?.gasConnectionBuild?.wsgInfo" @update:modelValue="(val) => {
                                if (gasConnection?.gasConnectionBuild) {
                                    gasConnection.gasConnectionBuild.wsgInfo = val as string;
                                }
                            }" :disabled="isReadonly" :rows="4" placeholder="" class="w-full" />
                        </div>
                    </div>
                </div>
            </template>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <InputText :modelValue="gasConnection?.pgn?.pgnNumber" @update:modelValue="(val) => {
                        ...
                        <div>
                            ...
                            <Textarea :modelValue="gasConnection?.pgn?.info" @update:modelValue="(val) => {
                                if (gasConnection?.pgn) {
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <DatePicker :modelValue="gasConnection?.pgn?.workDate" @update:modelValue="(val) => {
                                if (gasConnection?.pgn) {
                        ...
                        <div>
                            ...
                            <InputText :modelValue="gasConnection?.pgn?.applicationNumber" @update:modelValue="(val) => {
                                if (gasConnection?.pgn) {
                        ...
                        <div>
                            ...
                            <InputText :modelValue="gasConnection?.pgn?.recipient" @update:modelValue="(val) => {
                                if (gasConnection?.pgn) {
