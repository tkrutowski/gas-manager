...
<template>
  <Dialog
    ...
    :header="isEditMode ? 'Edytuj przyłącze' : 'Dodaj nowe przyłącze'"
    class="p-fluid"
  >
    <div class="space-y-4">
      <!-- ŚREDNICA -->
      <div>
        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2"> Średnica </label>
        <Select
          v-model="diameter"
      ...
      <!-- SDR -->
      <div>
        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2"> SDR </label>
        <Select
          v-model="sdr"
          :options="sdrOptions"
          placeholder="wybierz..."
      ...
      <!-- SZAFKĘ DOSTARCZA -->
      <div>
        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2"> Szafkę dostarcza </label>
        <Select
          v-model="gasCabinetProviderType"
          :options="gasCabinetProviderTypeOptions"
      ...
      <!-- INNE INFO -->
      <div>
        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2"> Inne info </label>
