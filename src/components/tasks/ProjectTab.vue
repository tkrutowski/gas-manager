<script setup lang="ts">
  ...
  import { DocumentIcon, MapPinIcon, ClipboardDocumentIcon, MapIcon } from '@heroicons/vue/24/outline';
...
<template>
  <div>
      ...
      <template #header>
        <div class="flex items-center justify-between w-full">
          <div class="flex items-center gap-4">
            ...
            <!-- Tekst -->
            <div>
              <div class="text-lg font-bold uppercase text-surface-700 dark:text-surface-300">ETAP 1</div>
          ...
          <div class="flex items-center gap-2">
            ...
            <!-- Ikona ustawień -->
            <Button icon="pi pi-cog" text severity="secondary" rounded @click="stageSettingsDialogVisible = true" />
          </div>
        </div>
      </template>
      ...
      <div class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="space-y-6">
            ...
            <Card
              :key="`projectOrder-${stage1SettingsKey}`"
            ...
            >
              <template #header>
                <div :class="getCardHeaderClasses('projectOrder')">
                  ...
                  <h4 :class="getCardHeaderTextClasses('projectOrder')">Zlecenie Projektu</h4>
                </div>
              </template>
              <template #content>
                <div class="space-y-4">
            ...
            >
              <template #header>
                <div :class="getCardHeaderClasses('proxy')">
                  <DocumentIcon class="w-5 h-5 text-primary-400" />
                  <h4 :class="getCardHeaderTextClasses('proxy')">Pełnomocnictwo</h4>
                </div>
              </template>
              <template #content>
                <div class="space-y-4">
            ...
            <!-- Karta WYPIS -->
            <Card
              :key="`extract-${stage1SettingsKey}`"
              data-card-id="extract"
              :class="`border ${getCardBorderClasses('extract')} overflow-hidden`"
            >
              <template #header>
                <div :class="getCardHeaderClasses('extract')">
                  <DocumentIcon class="w-5 h-5 text-primary-400" />
                  <h4 :class="getCardHeaderTextClasses('extract')">Wypis</h4>
                </div>
              </template>
              <template #content>
                <div class="space-y-4">
          ...
          <div class="space-y-6 col-span-2">
            ...
            >
              <template #header>
                <div :class="getCardHeaderClasses('map')">
                  ...
                  <h4 :class="getCardHeaderTextClasses('map')">Mapa</h4>
                </div>
              </template>
              <template #content>
            ...
            <!-- Karta WSPÓŁRZĘDNE -->
            <Card
              :key="`coordinates-${stage1SettingsKey}`"
            ...
            >
              <template #header>
                <div :class="getCardHeaderClasses('coordinates')">
                  ...
                  <h4 :class="getCardHeaderTextClasses('coordinates')">Współrzędne</h4>
                </div>
              </template>
              <template #content>
                <!-- Mapa -->
    ...
    <Panel :key="stage2SettingsKey" toggleable :collapsed="isStage2Collapsed" class="mt-6">
      <template #header>
        <div class="flex items-center justify-between w-full">
          <div class="flex items-center gap-4">
            ...
            <!-- Tekst -->
            <div>
              <div class="text-lg font-bold uppercase text-surface-700 dark:text-surface-300">ETAP 2</div>
          ...
          <div class="flex items-center gap-2">
            ...
            <!-- Ikona ustawień -->
            <Button icon="pi pi-cog" text severity="secondary" rounded @click="stage2SettingsDialogVisible = true" />
          </div>
        </div>
      </template>
      ...
      <div class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <template #header>
              <div :class="getCardHeaderClasses('zudp', 'stage2')">
                <DocumentIcon class="w-5 h-5 text-primary-400" />
                <h4 :class="getCardHeaderTextClasses('zudp', 'stage2')">ZUDP</h4>
              </div>
            </template>
            <template #content>
              <div class="space-y-4">
          ...
          <Card
            :key="`utilityCompany-${stage2SettingsKey}`"
          ...
          >
            <template #header>
              <div :class="getCardHeaderClasses('utilityCompany', 'stage2')">
                <DocumentIcon class="w-5 h-5 text-primary-400" />
                <h4 :class="getCardHeaderTextClasses('utilityCompany', 'stage2')">ZAKŁAD ...</h4>
              </div>
            </template>
            <template #content>
              <div class="space-y-4">
                <!-- Select "Rodzaj" -->
                <div>
                  <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2"> Rodzaj </label>
                  <Select
                ...
                <div>
                  ...
                  <DatePicker
                    ...
                    :disabled="
                      isUtilityCompanyDateFieldsDisabled ||
                      !gasConnection?.gasConnectionDesign?.utilityCompanySubmissionDate
                    "
                    :inputReadonly="true"
                    showIcon
                    :manualInput="false"
    ...
    <Panel :key="stage3SettingsKey" toggleable :collapsed="isStage3Collapsed" class="mt-6">
      <template #header>
        <div class="flex items-center justify-between w-full">
          <div class="flex items-center gap-4">
            ...
            <!-- Tekst -->
            <div>
              <div class="text-lg font-bold uppercase text-surface-700 dark:text-surface-300">ETAP 3</div>
          ...
          <div class="flex items-center gap-2">
            ...
            <!-- Ikona ustawień -->
            <Button icon="pi pi-cog" text severity="secondary" rounded @click="stage3SettingsDialogVisible = true" />
          </div>
        </div>
      </template>
      ...
      <div class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card
            :key="`wsgAgreement-${stage3SettingsKey}`"
          ...
          >
            <template #header>
              <div :class="getCardHeaderClasses('wsgAgreement', 'stage3')">
                <DocumentIcon class="w-5 h-5 text-primary-400" />
                <h4 :class="getCardHeaderTextClasses('wsgAgreement', 'stage3')">UZGODNIENIE WSG</h4>
              </div>
            </template>
            <template #content>
              <div class="space-y-4">
          ...
          <Card
            :key="`wsgAgreementPointScheme-${stage3SettingsKey}`"
                ...
                <div>
                  ...
                  <DatePicker
                    ...
                    @update:modelValue="
                      val => {
                        if (gasConnection?.gasConnectionDesign) {
                          gasConnection.gasConnectionDesign.wsgAgreementPointSchemeSubmissionDate = val as
                            | Date
                            | undefined;
                          // Jeśli wyczyszczono datę złożenia, wyczyść datę otrzymania
                          if (!val) {
                ...
                <div>
                  ...
                  <DatePicker
                    ...
                    @update:modelValue="
                      val => {
                        if (gasConnection?.gasConnectionDesign) {
                          gasConnection.gasConnectionDesign.wsgAgreementPointSchemeReceiptDate = val as
                            | Date
                            | undefined;
                        }
                      }
    ...
    <Panel :key="stage4SettingsKey" toggleable :collapsed="isStage4Collapsed" class="mt-6">
      <template #header>
        <div class="flex items-center justify-between w-full">
          <div class="flex items-center gap-4">
            ...
            <!-- Tekst -->
            <div>
              <div class="text-lg font-bold uppercase text-surface-700 dark:text-surface-300">ETAP 4</div>
          ...
          <div class="flex items-center gap-2">
            ...
            <!-- Ikona ustawień -->
            <Button icon="pi pi-cog" text severity="secondary" rounded @click="stage4SettingsDialogVisible = true" />
          </div>
        </div>
      </template>
      ...
      <div class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card
            :key="`trafficOrganizationProject-${stage4SettingsKey}`"
            ...
            <template #content>
              <div class="space-y-4">
                ...
                <div class="flex items-center gap-2">
                  ...
                  />
                  <label
                    for="withoutTrafficOrganizationProject"
                    class="text-sm font-medium text-surface-700 dark:text-surface-300 cursor-pointer"
                  >
                    bez POR
                  </label>
                ...
                <div>
                  ...
                  <DatePicker
                    ...
                    @update:modelValue="
                      val => {
                        if (gasConnection?.gasConnectionDesign) {
                          gasConnection.gasConnectionDesign.trafficOrganizationProjectSubmissionDate = val as
                            | Date
                            | undefined;
                          // Jeśli wyczyszczono datę złożenia, wyczyść datę otrzymania
                          if (!val) {
                ...
                <div>
                  ...
                  <DatePicker
                    ...
                    @update:modelValue="
                      val => {
                        if (gasConnection?.gasConnectionDesign) {
                          gasConnection.gasConnectionDesign.trafficOrganizationProjectReceiptDate = val as
                            | Date
                            | undefined;
                        }
                      }
                    ...
                    :disabled="
                      isTrafficOrganizationProjectDateFieldsDisabled ||
                      !gasConnection?.gasConnectionDesign?.trafficOrganizationProjectSubmissionDate
                    "
                    :inputReadonly="true"
                    showIcon
                    :manualInput="false"
          ...
          <div class="space-y-6">
            <!-- Card PUNKT GAZOWY -->
            <Card
              :key="`gasPoint-${stage4SettingsKey}`"
              data-card-id="gasPoint"
              :class="`border ${getCardBorderClasses('gasPoint', 'stage4')} overflow-hidden`"
            >
              <template #header>
                <div :class="getCardHeaderClasses('gasPoint', 'stage4')">
                  <DocumentIcon class="w-5 h-5 text-primary-400" />
                  <h4 :class="getCardHeaderTextClasses('gasPoint', 'stage4')">PUNKT GAZOWY</h4>
                </div>
              </template>
              <template #content>
                <div class="space-y-4">
            ...
            <!-- Card GEODEZJA -->
            <Card
              :key="`geodesy-${stage4SettingsKey}`"
              data-card-id="geodesy"
              :class="`border ${getCardBorderClasses('geodesy', 'stage4')} overflow-hidden`"
            >
              <template #header>
                <div :class="getCardHeaderClasses('geodesy', 'stage4')">
                  <DocumentIcon class="w-5 h-5 text-primary-400" />
                  <h4 :class="getCardHeaderTextClasses('geodesy', 'stage4')">GEODEZJA</h4>
                </div>
              </template>
              <template #content>
                <div class="space-y-4">
    ...
    <StageSettingsDialog
      v-model:visible="stageSettingsDialogVisible"
      stage-id="stage1"
      :cards="stage1Cards"
      @saved="
        () => {
    ...
    <StageSettingsDialog
      v-model:visible="stage2SettingsDialogVisible"
      stage-id="stage2"
      :cards="stage2Cards"
      @saved="
        () => {
    ...
    <StageSettingsDialog
      v-model:visible="stage3SettingsDialogVisible"
      stage-id="stage3"
      :cards="stage3Cards"
      @saved="
        () => {
    ...
    <StageSettingsDialog
      v-model:visible="stage4SettingsDialogVisible"
      stage-id="stage4"
      :cards="stage4Cards"
      @saved="
        () => {
