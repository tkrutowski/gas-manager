      ...
      <Fieldset legend="Termin dodatkowy I" class="mb-4">
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <DatePicker
              v-model="receiptDate1"
              :disabled="isReceiptDate1Disabled"
              :inputReadonly="true"
              :manualInput="false"
              showButtonBar
              showIcon
      ...
      <Fieldset legend="Termin dodatkowy II" class="mb-4">
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <DatePicker
              v-model="receiptDate2"
              :disabled="isReceiptDate2Disabled"
              :inputReadonly="true"
              :manualInput="false"
              showButtonBar
              showIcon
