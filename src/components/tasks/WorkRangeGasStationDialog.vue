...
<template>
  <Dialog
    ...
    :header="isEditMode ? 'Edytuj punkt/stację' : 'Dodaj nowy punkt/stację'"
    class="p-fluid"
  >
    <div class="space-y-4">
      <!-- PRZEPUSTOWOŚĆ -->
      <div>
        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2"> Przepustowość: </label>
      ...
      <!-- ILOŚĆ -->
      <div>
        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2"> Ilość: </label>
        <div class="flex items-center gap-2">
      ...
      <!-- RODZAJ STACJI -->
      <div>
        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2"> Rodzaj stacji: </label>
        <Select
          v-model="stationType"
