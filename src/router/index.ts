...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/finance/invoices/grid',
      name: 'invoices-grid',
      component: () => import('../views/finance/InvoicesGrid.vue'),
      meta: { requiresAuth: true },
    },
    {
      path: '/finance/corrections/new',
      name: 'new-correction',
      component: () => import('../views/finance/PlaceholderView.vue'),
      meta: { requiresAuth: true },
    },
    {
      path: '/finance/corrections/list',
      name: 'corrections-list',
      component: () => import('../views/finance/PlaceholderView.vue'),
      meta: { requiresAuth: true },
    },
    {
      path: '/finance/corrections/grid',
      name: 'corrections-grid',
      component: () => import('../views/finance/PlaceholderView.vue'),
      meta: { requiresAuth: true },
    },
    {
      path: '/finance/offers/new',
      name: 'new-offer',
      component: () => import('../views/finance/PlaceholderView.vue'),
      meta: { requiresAuth: true },
    },
    {
      path: '/finance/offers/list',
      name: 'offers-list',
      component: () => import('../views/finance/PlaceholderView.vue'),
      meta: { requiresAuth: true },
    },
    {
      path: '/finance/offers/grid',
      name: 'offers-grid',
      component: () => import('../views/finance/PlaceholderView.vue'),
      meta: { requiresAuth: true },
    },
