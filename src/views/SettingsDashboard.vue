        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <section id="company-basic"
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <InputText v-model="formCompany.name"
                ...
                <div>
                  ...
                  <InputText v-model="formCompany.taxId"
                    class="w-full bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 text-surface-800 dark:text-surface-200" />
                </div>
                <div>
                  <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">
                  ...
                  <InputText v-model="formCompany.regon"
                    class="w-full bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 text-surface-800 dark:text-surface-200" />
                </div>
                <div>
                  <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">
                  ...
                  <InputText v-model="formCompany.krs"
                    class="w-full bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 text-surface-800 dark:text-surface-200" />
                </div>
              </div>
            </section>
            ...
            <section id="company-address"
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                  ...
                  <InputText v-model="formCompany.address.street"
                    class="w-full bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 text-surface-800 dark:text-surface-200" />
                </div>
                <div>
                  <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">
                  ...
                  <InputText v-model="formCompany.address.zipCode"
                    class="w-full bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 text-surface-800 dark:text-surface-200" />
                </div>
                <div>
                  <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">
                  ...
                  <InputText v-model="formCompany.address.city"
                    class="w-full bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 text-surface-800 dark:text-surface-200" />
                </div>
              </div>
            </section>
                ...
                <div>
                  ...
                  <div class="space-y-2">
                    <div v-for="(phone, index) in formCompany.phones" :key="index" class="flex items-center gap-2">
                      ...
                      <InputText v-model="formCompany.phones[index]"
                      ...
                      <button type="button"
                        ...
                        title="Usuń numer telefonu" @click="handleRemovePhone(index)">
                    ...
                    <button type="button" class="text-xs text-primary-500 hover:text-primary-400"
                ...
                <div>
                  ...
                  <div class="space-y-2">
                    <div v-for="(email, index) in formCompany.emails" :key="index" class="flex items-center gap-2">
                      ...
                      <InputText v-model="formCompany.emails[index]"
                        class="flex-1 bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 text-surface-800 dark:text-surface-200" />
                      <button type="button"
                        class="p-1 text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors"
                        title="Usuń adres e-mail" @click="handleRemoveEmail(index)">
                        <TrashIcon class="w-4 h-4" />
                      </button>
                    </div>
            ...
            <section id="company-bank"
              ...
              <div class="space-y-3">
                <div v-for="(account, index) in formCompany.bankAccounts" :key="index"
                  class="border border-surface-200 dark:border-surface-700 rounded-lg px-4 py-3 flex flex-col gap-1">
                  <div class="flex flex-col md:flex-row md:items-center gap-2">
                    <InputText v-model="account.name" placeholder="Nazwa konta"
                    ...
                    <InputText v-model="account.iban" placeholder="Numer IBAN"
                      class="flex-1 bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 text-surface-800 dark:text-surface-200" />
                    <button type="button"
                      class="p-1 text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors"
                      title="Usuń konto bankowe" @click="handleRemoveBankAccount(index)">
                      <TrashIcon class="w-4 h-4" />
                    </button>
                  </div>
                </div>
            ...
            <div class="flex justify-end">
              <PrimaryButton type="button" size="lg" text="Zapisz dane firmy" :disabled="!isCompanyDirty"
          ...
          <div class="space-y-6">
            <section id="app-settings"
              ...
              <div class="space-y-3">
                ...
                <div>
                  ...
                  <InputText v-model="formAppInfo.appVersion"
                    class="w-full bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 text-surface-800 dark:text-surface-200" />
                </div>
              </div>

              <div class="mt-4 flex justify-end">
                <PrimaryButton type="button" size="lg" text="Zapisz ustawienia aplikacji" :disabled="!isAppInfoDirty"
            ...
            <section
              ...
              <p class="text-xs md:text-sm text-surface-600 dark:text-surface-400">
                Ustawienia są obecnie przechowywane lokalnie w przeglądarce (localStorage) i służą jako
                konfiguracja domyślna. W przyszłości mogą zostać zastąpione ustawieniami z API.
              </p>
            </section>
          </div>
        </div>
