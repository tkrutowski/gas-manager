      ...
      <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-surface-50 dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-xl p-4">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-semibold text-surface-700 dark:text-surface-300">Lista projektantów</h2>
            <p class="text-xs text-surface-500 dark:text-surface-400">Kliknij kartę, aby zaznaczyć projektanta.</p>
          </div>
