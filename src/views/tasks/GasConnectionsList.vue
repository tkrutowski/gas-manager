            ...
            <div class="max-w-full mx-auto">
                <div class="mb-6 flex items-start justify-between gap-4">
                    ...
                    <div v-if="selectedRow"
                        ...
                        <div class="flex gap-6 text-sm">
                            ...
                            <div class="flex flex-col">
                                <span
                                    class="text-surface-600 dark:text-surface-400 font-medium whitespace-nowrap text-xs">Dystrybutor
                                    gazu</span>
                                <span class="text-surface-700 dark:text-surface-300 whitespace-nowrap">{{
                ...
                <div
                        ...
                        <Toolbar
                            ...
                            <template #start>
                                <div class="flex items-center gap-2">
                                    ...
                                    <!-- Pionowa kreska separatora -->
                                    <div class="h-8 w-px bg-surface-300 dark:bg-surface-600 mx-1"></div>
                                    <Button :icon="isSelectedFavorite ? 'pi pi-star-fill' : 'pi pi-star'" text
                    ...
                    <DataTable :value="filteredGasConnections" :loading="loading" :reorderableColumns="true"
                        ...
                        <template #empty>
                            <div class="text-center py-8 text-surface-600 dark:text-surface-400">Brak danych do
                                wyświetlenia</div>
                        </template>
                    </DataTable>
                </div>
