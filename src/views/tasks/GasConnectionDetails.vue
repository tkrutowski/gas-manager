      ...
      <div class="max-w-full mx-auto">
        <div class="mb-6">
          <div class="flex items-center gap-2 mb-2">
            <button
              @click="router.push('/tasks/gas-connections')"
        ...
        <div v-if="gasConnection" class="grid grid-cols-1 xl:grid-cols-[300px_1fr] gap-6 mb-6">
          ...
          >
            <h2 class="text-xl font-bold text-surface-700 dark:text-surface-300 mb-6">Dane Zadania</h2>
            <Divider />
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 gap-2">
                ...
                <div>
                  <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1"> Ulica, Działka </label>
                  <p class="text-sm font-semibold text-surface-700 dark:text-surface-300">
                    {{ streetAndPlot }}
                  </p>
                </div>
              ...
              <div class="grid grid-cols-2 gap-2">
                <div>
                  <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1"> Nr Zlecenia </label>
                  <p class="text-sm font-semibold text-orange-600 dark:text-orange-400">
                    {{ gasConnection.taskNo || '-' }}
                  </p>
                </div>
                <div>
                  <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1"> Nr SAP/UP </label>
                  <p class="text-sm font-semibold text-orange-600 dark:text-orange-400">
                    {{ gasConnection.sapUpNo || '-' }}
                  </p>
                </div>
                <div>
                  <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1"> Nr Umowy </label>
                  <p class="text-sm font-semibold text-surface-700 dark:text-surface-300">
                    {{ gasConnection.contractNo || '-' }}
                  </p>
                </div>
                <div>
                  <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1"> Data Umowy </label>
                  <p class="text-sm font-semibold text-surface-700 dark:text-surface-300">
              ...
              <div class="grid grid-cols-1 gap-2">
                <div>
                  <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1"> Projektant </label>
                  <p class="text-sm font-semibold text-surface-700 dark:text-surface-300">
                    {{ getPersonDisplayName(gasConnection.designer) || '-' }}
                  </p>
                </div>
                <div>
                  <label class="block text-xs text-surface-600 dark:text-surface-400 mb-1"> Koordynator </label>
                  <p class="text-sm font-semibold text-surface-700 dark:text-surface-300">
              ...
              <div class="space-y-0">
                <div class="flex items-center justify-between">
                  <label class="text-xs text-surface-600 dark:text-surface-400"> Wartość proj. </label>
                  <p class="text-sm font-semibold text-surface-700 dark:text-surface-300">
                    {{ formatMoney(gasConnection.projectValue) || '-' }}
                  </p>
                </div>
                <div class="flex items-center justify-between">
                  <label class="text-xs text-surface-600 dark:text-surface-400"> Wartość wyk. </label>
                  <p class="text-sm font-semibold text-surface-700 dark:text-surface-300">
                ...
                <Divider type="dashed" />
                <div class="flex items-center justify-between">
                  <label class="text-xs font-bold text-surface-700 dark:text-surface-300"> Wartość zad. </label>
                ...
                <TabPanel value="finanse-cd">
                  <div class="p-6">
                    <p class="text-surface-600 dark:text-surface-400">
                      Zawartość zakładki Finanse cd. będzie uzupełniona w późniejszym terminie.
                    </p>
                  </div>
                </TabPanel>
